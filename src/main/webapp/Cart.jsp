...
<div id="profileDetails" class="container mt-3 bg-light p-3 rounded d-none">
    <h5>User Profile</h5>
    <div class="row">
        <div class="col-md-6">
        ...
        <div class="col-md-6">
            ...
            <p><strong>Status:</strong> 
                <span class="<%= user.get("status").equals("Active") ? "text-success" : "text-danger" %>">
                    <%= user.get("status") %>
                </span>
            </p>
        </div>
  ...
  <header class="container mt-4 p-4"  style="background-color: lightblue; border-radius: 30px;">
  <div class="bg-light m-3 p-5">
    ...
    %>
        <div class="d-flex align-items-center justify-content-between p-3 bg-light border-bottom">
            <div class="d-flex align-items-center">
                <img height="50px" class="rounded mr-3" src="GetImage?name=<%= item_name %>" alt="<%= item_name %>">
                <div>
    ...
    %>
        <div class="text-right mt-4 bg-light p-3">
            <h6>Total Amount: <span class="text-primary">&#8377;<%= total %></span></h6>
