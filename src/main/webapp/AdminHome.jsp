...
<body>
 ...
 <nav class="navbar navbar-expand-sm container">
  ...
  <div class="collapse navbar-collapse" id="my-navbar">
    <ul class="navbar-nav mx-auto">
      <li>
        ...
        <!-- Search box -->
      <li>  <form class="form-inline my-2 my-lg-0 mr-3" action="SearchResults.jsp" method="get">
      <input
  ...
  <header class="container mt-4 pt-5 p-5" style="background-color: lightblue; border-radius: 30px;">
      ...
      <form  action="AddItem" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
          <input type="text" name="cname" maxlength="100" class="form-control" placeholder="Company Name" required/>
        </div>
        <div class="form-group">
          <input type="text" name="salt" maxlength="100" class="form-control" placeholder="Salt(if applicable)" />
        </div>
        <div class="form-group">
          <input type="text" name="price" pattern="[0-9.]+" maxlength="10" class="form-control" placeholder="Price" required/>
        </div>
        <div class="form-group">
