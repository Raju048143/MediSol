...
<body>
	...
	<header class="container mt-4 py-4"
				...
				<form action="SearchItems.jsp" method="post">
					<div class="form-row">
						<div class="col-12 col-md-10">
							<input class="form-control border-light rounded-pill" type="text"
								name="name" maxlength="100"
								placeholder="Medicine name/Product name" required />
						</div>
						<div class="col-12 col-md-2 mt-2 mt-md-0">
							<button type="submit"
								class="btn btn-light btn-block rounded-pill shadow-sm hover-shadow">Search</button>
						</div>
					</div>
				</form>
			</div>
		...
		<div class="row justify-content-center">
			<div class="col-lg-8 col-md-10 col-12">
				...
				<form action="UploadPrescription" method="post"
					...
					<div class="form-row">
						<div class="col-12 col-md-10">
							<input class="form-control border-light rounded-pill" type="file"
								accept=".jpg,.jpeg,.png" name="image" required />
						</div>
						<div class="col-12 col-md-2 mt-2 mt-md-0">
							<button type="submit"
								class="btn btn-light btn-block rounded-pill shadow-sm hover-shadow">Submit</button>
						</div>
					</div>
				</form>
			</div>
